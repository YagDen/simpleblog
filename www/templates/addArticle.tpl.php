        ...
        <form method="post" action="addArticle.php">
            <fieldset>
                ...
                <input type="text" name="title" placeholder="Название статьи"
                       value="<?= @decodeText($articleTitle); ?>" required><br/><br/>
                <textarea name="text" placeholder="Введите текст статьи"
                          cols=55 rows=25 required><?= @decodeText($text); ?></textarea><br/><br/>
